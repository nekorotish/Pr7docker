...
export const FullPost = ({route, navigation}) => {
    ...
    const {id, user_id_get} = route.params;
        ...
        <SafeAreaView>
            <ScrollView refreshControl={
                ...
                <View style={{padding: 20}}>
                    ...
                    <View onTouchEndCapture={() => navigation.navigate("AccountView", {user_id: user_data_get._id})}
                          style={{flexDirection: 'row', justifyContent: "flex-start", marginTop: 5}}>
                        <Feather name="user" size={24} color={currentTheme === "dark" ? 'white' : "black"}/>
                        <MiniText style={{marginTop: 5, marginLeft: 5}}
                                  color={currentTheme === "dark" ? 'white' : "black"}>{user_data_get.fullname}</MiniText>
                    </View>
                    ...
                    <View style={{display: 'flex', flexDirection: 'row', width: '100%'}}>
                        ...
                        <View style={{flex: 1, marginRight: 10}}>
                            ...
                            <MiniTitle
                                color={currentTheme === 'dark' ? 'white' : 'black'}>{t('Camera Company')}</MiniTitle>
                            ...
                            <MiniTitle
                                color={currentTheme === 'dark' ? 'white' : 'black'}>{t('ShutterSpeed')}</MiniTitle>
                            <MiniText style={{marginTop: 3}}
                        ...
                        <View style={{marginLeft: 'auto', marginTop: 25}}>
                            <MiniTitle
                                color={currentTheme === 'dark' ? 'white' : 'black'}>{t('FocalLength')}</MiniTitle>
                            <MiniText style={{marginTop: 3}}
